        ...
        <div className="space-y-4">
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-500/30 rounded-lg p-4">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-sm mb-3">
              Your work is protected using <strong className="text-blue-600 dark:text-blue-400">immediate Ethereum anchoring</strong> - creating instantly verifiable proofs on the Ethereum mainnet blockchain.
            </p>
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-start gap-2">
                <CheckCircle2 className="h-4 w-4 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-gray-700 dark:text-gray-300 font-medium">Immediate Ethereum proof anchored to current blockchain block</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle2 className="h-4 w-4 text-emerald-500 mt-0.5 flex-shrink-0" />
                <span className="text-gray-700 dark:text-gray-300 font-medium">Instantly verifiable through Etherscan and other Ethereum block explorers</span>
              </div>
            </div>
          </div>
