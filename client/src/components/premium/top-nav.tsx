    ...
    <nav className={`hidden md:flex items-center justify-between px-8 py-6 bg-white/80 backdrop-blur-xl border-b border-gray-200/50 sticky top-0 z-40 transition-transform duration-300 shadow-lg ${
      ...
      <div className="flex-1 max-w-md mx-8">
        <div className="relative">
          ...
          {showSearchResults && searchResults.length > 0 && (
            <>
              <div className="fixed inset-0 z-40 backdrop-blur-sm bg-black/5" onClick={() => setShowSearchResults(false)}></div>
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="relative">
          ...
          {isMenuOpen && (
            <>
              <div className="fixed inset-0 z-40 backdrop-blur-sm bg-black/5" onClick={() => setIsMenuOpen(false)}></div>
